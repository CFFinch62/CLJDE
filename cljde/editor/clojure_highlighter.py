"""Clojure syntax highlighter for the CLJDE editor.
...
Token classes recognised, all styled from :data:`cljde.config.theme.DEFAULT_PALETTE`:
...
from cljde.editor.rainbow_parens import build_rainbow_formats, format_for_depth
